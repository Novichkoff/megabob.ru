...
class AdCategoryFieldValuesListType extends AbstractType
{
    ...
    public function buildForm(FormBuilderInterface $builder, array $options)
    {
        ...
        if ($options['data']->getParentValueId()) {
            $parent_values = AdCategoriesFieldsValuesQuery::create()->findByFieldId($options['data']->getParentValueId());
