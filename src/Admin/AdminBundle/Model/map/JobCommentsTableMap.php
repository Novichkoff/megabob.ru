...
/**
 * This class defines the structure of the 'job_comments' table.
 *
 *
 *
 ...
 */
class JobCommentsTableMap extends TableMap
{

    /**
     * The (dot-path) name of this class
     */
    const CLASS_NAME = 'src.Admin.AdminBundle.Model.map.JobCommentsTableMap';
    ...
    {
        // attributes
        $this->setName('job_comments');
        $this->setPhpName('JobComments');
        $this->setClassname('Admin\\AdminBundle\\Model\\JobComments');
