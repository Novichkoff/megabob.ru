...
/**
 * This class defines the structure of the 'adv_price' table.
 *
 *
 *
 ...
 */
class AdvPriceTableMap extends TableMap
{

    /**
     * The (dot-path) name of this class
     */
    const CLASS_NAME = 'src.Admin.AdminBundle.Model.map.AdvPriceTableMap';
    ...
    {
        // attributes
        $this->setName('adv_price');
        $this->setPhpName('AdvPrice');
        $this->setClassname('Admin\\AdminBundle\\Model\\AdvPrice');
