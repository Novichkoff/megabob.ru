...
/**
 * This class defines the structure of the 'adv_packets' table.
 *
 *
 *
 ...
 */
class AdvPacketsTableMap extends TableMap
{

    /**
     * The (dot-path) name of this class
     */
    const CLASS_NAME = 'src.Admin.AdminBundle.Model.map.AdvPacketsTableMap';
    ...
    {
        // attributes
        $this->setName('adv_packets');
        $this->setPhpName('AdvPackets');
        $this->setClassname('Admin\\AdminBundle\\Model\\AdvPackets');
        $this->setPackage('src.Admin.AdminBundle.Model');
        $this->setUseIdGenerator(true);
        // columns
        $this->addPrimaryKey('id', 'Id', 'INTEGER', true, null, null);
        $this->addForeignKey('adv_id', 'AdvId', 'INTEGER', 'advs', 'id', true, null, null);
        $this->addForeignKey('packet_id', 'PacketId', 'INTEGER', 'packets', 'id', true, null, null);
    ...
    public function buildRelations()
    {
        ...
        $this->addRelation('Packets', 'Admin\\AdminBundle\\Model\\Packets', RelationMap::MANY_TO_ONE, array('packet_id' => 'id', ), 'CASCADE', null);
    } // buildRelations()
