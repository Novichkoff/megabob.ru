...
/**
 * This class defines the structure of the 'coupon_images' table.
 *
 *
 *
 ...
 */
class CouponImagesTableMap extends TableMap
{

    /**
     * The (dot-path) name of this class
     */
    const CLASS_NAME = 'src.Admin.AdminBundle.Model.map.CouponImagesTableMap';
    ...
    {
        // attributes
        $this->setName('coupon_images');
        $this->setPhpName('CouponImages');
        $this->setClassname('Admin\\AdminBundle\\Model\\CouponImages');
