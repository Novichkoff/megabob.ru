...
class MenuTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'src.Admin.AdminBundle.Model.map.MenuTableMap';
    ...
    public function initialize()
    {
        ...
        $this->setClassname('Admin\\AdminBundle\\Model\\Menu');
        ...
        $this->getColumn('path', false)->setPrimaryString(true);
        // validators
    } // initialize()
