...
/**
 * This class defines the structure of the 'advs_modify' table.
 *
 *
 *
 ...
 */
class AdvsModifyTableMap extends TableMap
{

    /**
     * The (dot-path) name of this class
     */
    const CLASS_NAME = 'src.Admin.AdminBundle.Model.map.AdvsModifyTableMap';
    ...
    {
        // attributes
        $this->setName('advs_modify');
        $this->setPhpName('AdvsModify');
        $this->setClassname('Admin\\AdminBundle\\Model\\AdvsModify');
