...
/**
 * This class defines the structure of the 'adv_videos' table.
 *
 *
 *
 ...
 */
class AdvVideosTableMap extends TableMap
{

    /**
     * The (dot-path) name of this class
     */
    const CLASS_NAME = 'src.Admin.AdminBundle.Model.map.AdvVideosTableMap';
    ...
    {
        // attributes
        $this->setName('adv_videos');
        $this->setPhpName('AdvVideos');
        $this->setClassname('Admin\\AdminBundle\\Model\\AdvVideos');
