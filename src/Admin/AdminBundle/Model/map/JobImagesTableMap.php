...
/**
 * This class defines the structure of the 'job_images' table.
 *
 *
 *
 ...
 */
class JobImagesTableMap extends TableMap
{

    /**
     * The (dot-path) name of this class
     */
    const CLASS_NAME = 'src.Admin.AdminBundle.Model.map.JobImagesTableMap';
    ...
    {
        // attributes
        $this->setName('job_images');
        $this->setPhpName('JobImages');
        $this->setClassname('Admin\\AdminBundle\\Model\\JobImages');
