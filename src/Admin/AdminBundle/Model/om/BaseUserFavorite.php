...
abstract class BaseUserFavorite extends BaseObject implements Persistent
{
     ...
     * Peer class name
     */
    const PEER = 'Admin\\AdminBundle\\Model\\UserFavoritePeer';
    ...
    public function setFosUserId($v)
    {
        ...
        if ($this->fos_user_id !== $v) {
            $this->fos_user_id = $v;
            $this->modifiedColumns[] = UserFavoritePeer::FOS_USER_ID;
        }
    ...
    public function setAdvId($v)
    {
        ...
        if ($this->adv_id !== $v) {
            $this->adv_id = $v;
            $this->modifiedColumns[] = UserFavoritePeer::ADV_ID;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            $this->adv_id = ($row[$startcol + 2] !== null) ? (int) $row[$startcol + 2] : null;
            $this->resetModified();
            ...
            return $startcol + 3; // 3 = UserFavoritePeer::NUM_HYDRATE_COLUMNS.
    ...
    public function delete(PropelPDO $con = null)
    {
        ...
        try {
            $deleteQuery = UserFavoriteQuery::create()
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if ($this->isColumnModified(UserFavoritePeer::ID)) {
            $modifiedColumns[':p' . $index++]  = '`id`';
        }
        if ($this->isColumnModified(UserFavoritePeer::FOS_USER_ID)) {
            $modifiedColumns[':p' . $index++]  = '`fos_user_id`';
        }
        if ($this->isColumnModified(UserFavoritePeer::ADV_ID)) {
    ...
    {
        if (isset($alreadyDumpedObjects['UserFavorite'][$this->getPrimaryKey()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['UserFavorite'][$this->getPrimaryKey()] = true;
        $keys = UserFavoritePeer::getFieldNames($keyType);
        $result = array(
            $keys[0] => $this->getId(),
            $keys[1] => $this->getFosUserId(),
            $keys[2] => $this->getAdvId(),
        );
    ...
    public function fromArray($arr, $keyType = BasePeer::TYPE_PHPNAME)
    {
        ...
        if (array_key_exists($keys[2], $arr)) $this->setAdvId($arr[$keys[2]]);
    }
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(UserFavoritePeer::FOS_USER_ID)) $criteria->add(UserFavoritePeer::FOS_USER_ID, $this->fos_user_id);
        if ($this->isColumnModified(UserFavoritePeer::ADV_ID)) $criteria->add(UserFavoritePeer::ADV_ID, $this->adv_id);
    ...
    public function getAdvs(PropelPDO $con = null, $doQuery = true)
    {
        if ($this->aAdvs === null && ($this->adv_id !== null) && $doQuery) {
            ...
            /* The following can be used additionally to
                ...
                undesirable since it could result in an only partially populated collection
                in the referenced object.
                $this->aAdvs->addUserFavorites($this);
             */
        }
    ...
    {
        return (string) $this->exportTo(UserFavoritePeer::DEFAULT_STRING_FORMAT);
    }
