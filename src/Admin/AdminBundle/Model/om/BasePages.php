...
abstract class BasePages extends BaseObject implements Persistent
{
     ...
     * Peer class name
     */
    const PEER = 'Admin\\AdminBundle\\Model\\PagesPeer';
    ...
    public function setIcon($v)
    {
        ...
        if ($this->icon !== $v) {
            $this->icon = $v;
            $this->modifiedColumns[] = PagesPeer::ICON;
        }
    ...
    public function setDescription($v)
    {
        ...
        if ($this->description !== $v) {
            $this->description = $v;
            $this->modifiedColumns[] = PagesPeer::DESCRIPTION;
        }
    ...
    public function setViewed($v)
    {
        ...
        if ($this->viewed !== $v) {
            $this->viewed = $v;
            $this->modifiedColumns[] = PagesPeer::VIEWED;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            $this->viewed = ($row[$startcol + 5] !== null) ? (int) $row[$startcol + 5] : null;
    ...
    public function save(PropelPDO $con = null)
    {
        ...
        try {
            ...
            if ($isInsert) {
                ...
                if (!$this->isColumnModified(PagesPeer::UPDATED_AT)) {
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if ($this->isColumnModified(PagesPeer::ICON)) {
            $modifiedColumns[':p' . $index++]  = '`icon`';
        }
        if ($this->isColumnModified(PagesPeer::DESCRIPTION)) {
            $modifiedColumns[':p' . $index++]  = '`description`';
        }
        if ($this->isColumnModified(PagesPeer::VIEWED)) {
    ...
    public function fromArray($arr, $keyType = BasePeer::TYPE_PHPNAME)
    {
        ...
        if (array_key_exists($keys[5], $arr)) $this->setViewed($arr[$keys[5]]);
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(PagesPeer::ICON)) $criteria->add(PagesPeer::ICON, $this->icon);
        if ($this->isColumnModified(PagesPeer::DESCRIPTION)) $criteria->add(PagesPeer::DESCRIPTION, $this->description);
        if ($this->isColumnModified(PagesPeer::VIEWED)) $criteria->add(PagesPeer::VIEWED, $this->viewed);
