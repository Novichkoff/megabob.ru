...
abstract class BaseAdvVideos extends BaseObject implements Persistent
{
    /**
     * Peer class name
     */
    const PEER = 'Admin\\AdminBundle\\Model\\AdvVideosPeer';
    ...
    /**
     * Initializes internal state of BaseAdvVideos object.
     * @see        applyDefaults()
     */
     ...
     * @return AdvVideos The current object (for fluent API support)
     */
    public function setId($v)
    {
        ...
        if ($this->id !== $v) {
            $this->id = $v;
            $this->modifiedColumns[] = AdvVideosPeer::ID;
        }
    ...
    public function setAdvId($v)
    {
        ...
        if ($this->adv_id !== $v) {
            $this->adv_id = $v;
            $this->modifiedColumns[] = AdvVideosPeer::ADV_ID;
        }
    ...
    public function setPath($v)
    {
        ...
        if ($this->path !== $v) {
            $this->path = $v;
            $this->modifiedColumns[] = AdvVideosPeer::PATH;
        }
    ...
    public function setThumb($v)
    {
        ...
        if ($this->thumb !== $v) {
            $this->thumb = $v;
            $this->modifiedColumns[] = AdvVideosPeer::THUMB;
        }
    ...
    public function setTempId($v)
    {
        ...
        if ($this->temp_id !== $v) {
            $this->temp_id = $v;
            $this->modifiedColumns[] = AdvVideosPeer::TEMP_ID;
        }
    ...
    public function setUploadDate($v)
    {
        ...
        if ($this->upload_date !== null || $dt !== null) {
            ...
            if ($currentDateAsString !== $newDateAsString) {
                ...
                $this->modifiedColumns[] = AdvVideosPeer::UPLOAD_DATE;
            }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            return $startcol + 6; // 6 = AdvVideosPeer::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException("Error populating AdvVideos object", $e);
        }
    }
    ...
    public function reload($deep = false, PropelPDO $con = null)
    {
        ...
        $stmt = AdvVideosPeer::doSelectStmt($this->buildPkeyCriteria(), $con);
    ...
    public function delete(PropelPDO $con = null)
    {
        ...
        try {
            $deleteQuery = AdvVideosQuery::create()
    ...
    public function save(PropelPDO $con = null)
    {
        ...
        try {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                AdvVideosPeer::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
            $con->commit();
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if ($this->isColumnModified(AdvVideosPeer::ID)) {
            $modifiedColumns[':p' . $index++]  = '`id`';
        }
        if ($this->isColumnModified(AdvVideosPeer::ADV_ID)) {
            $modifiedColumns[':p' . $index++]  = '`adv_id`';
        }
        if ($this->isColumnModified(AdvVideosPeer::PATH)) {
            $modifiedColumns[':p' . $index++]  = '`path`';
        }
        if ($this->isColumnModified(AdvVideosPeer::THUMB)) {
            $modifiedColumns[':p' . $index++]  = '`thumb`';
        }
        if ($this->isColumnModified(AdvVideosPeer::TEMP_ID)) {
            $modifiedColumns[':p' . $index++]  = '`temp_id`';
        }
        if ($this->isColumnModified(AdvVideosPeer::UPLOAD_DATE)) {
            $modifiedColumns[':p' . $index++]  = '`upload_date`';
        }

        $sql = sprintf(
            'INSERT INTO `adv_videos` (%s) VALUES (%s)',
    ...
    protected function doValidate($columns = null)
    {
        if (!$this->alreadyInValidation) {
            ...
            if (($retval = AdvVideosPeer::doValidate($this, $columns)) !== true) {
    ...
    {
        $pos = AdvVideosPeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
    ...
    {
        if (isset($alreadyDumpedObjects['AdvVideos'][$this->getPrimaryKey()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['AdvVideos'][$this->getPrimaryKey()] = true;
        $keys = AdvVideosPeer::getFieldNames($keyType);
        $result = array(
            $keys[0] => $this->getId(),
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(AdvVideosPeer::ID)) $criteria->add(AdvVideosPeer::ID, $this->id);
        if ($this->isColumnModified(AdvVideosPeer::ADV_ID)) $criteria->add(AdvVideosPeer::ADV_ID, $this->adv_id);
        if ($this->isColumnModified(AdvVideosPeer::PATH)) $criteria->add(AdvVideosPeer::PATH, $this->path);
        if ($this->isColumnModified(AdvVideosPeer::THUMB)) $criteria->add(AdvVideosPeer::THUMB, $this->thumb);
        if ($this->isColumnModified(AdvVideosPeer::TEMP_ID)) $criteria->add(AdvVideosPeer::TEMP_ID, $this->temp_id);
        if ($this->isColumnModified(AdvVideosPeer::UPLOAD_DATE)) $criteria->add(AdvVideosPeer::UPLOAD_DATE, $this->upload_date);
    ...
    {
        $criteria = new Criteria(AdvVideosPeer::DATABASE_NAME);
        $criteria->add(AdvVideosPeer::ID, $this->id);
     ...
     * objects.
     *
     * @param object $copyObj An object of AdvVideos (or compatible) type.
     ...
     *
     * @param boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return AdvVideos Clone of current object.
     * @throws PropelException
     */
     ...
     *
     * @return AdvVideosPeer
     */
    public function getPeer()
    {
        if (self::$peer === null) {
            self::$peer = new AdvVideosPeer();
        }
    ...
    {
        return (string) $this->exportTo(AdvVideosPeer::DEFAULT_STRING_FORMAT);
    }
