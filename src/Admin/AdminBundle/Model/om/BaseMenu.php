...
abstract class BaseMenu extends BaseObject implements Persistent
{
     ...
     * Peer class name
     */
    const PEER = 'Admin\\AdminBundle\\Model\\MenuPeer';
    ...
    public function setPath($v)
    {
        ...
        if ($this->path !== $v) {
            $this->path = $v;
            $this->modifiedColumns[] = MenuPeer::PATH;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            return $startcol + 3; // 3 = MenuPeer::NUM_HYDRATE_COLUMNS.
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if ($this->isColumnModified(MenuPeer::PATH)) {
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(MenuPeer::PATH)) $criteria->add(MenuPeer::PATH, $this->path);
