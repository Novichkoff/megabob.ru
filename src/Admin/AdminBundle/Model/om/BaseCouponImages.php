...
abstract class BaseCouponImages extends BaseObject implements Persistent
{
    /**
     * Peer class name
     */
    const PEER = 'Admin\\AdminBundle\\Model\\CouponImagesPeer';

    /**
     * The Peer class.
     * Instance provides a convenient way of calling static methods on a class
     * that calling code may not be able to identify.
     * @var        CouponImagesPeer
     */
    ...
    /**
     * Initializes internal state of BaseCouponImages object.
     * @see        applyDefaults()
     */
     ...
     * @return CouponImages The current object (for fluent API support)
     */
    public function setId($v)
    {
        ...
        if ($this->id !== $v) {
            $this->id = $v;
            $this->modifiedColumns[] = CouponImagesPeer::ID;
        }
    ...
    public function setCouponId($v)
    {
        ...
        if ($this->coupon_id !== $v) {
            $this->coupon_id = $v;
            $this->modifiedColumns[] = CouponImagesPeer::COUPON_ID;
        }
    ...
    public function setPath($v)
    {
        ...
        if ($this->path !== $v) {
            $this->path = $v;
            $this->modifiedColumns[] = CouponImagesPeer::PATH;
        }
    ...
    public function setThumb($v)
    {
        ...
        if ($this->thumb !== $v) {
            $this->thumb = $v;
            $this->modifiedColumns[] = CouponImagesPeer::THUMB;
        }
    ...
    public function setTempId($v)
    {
        ...
        if ($this->temp_id !== $v) {
            $this->temp_id = $v;
            $this->modifiedColumns[] = CouponImagesPeer::TEMP_ID;
        }
    ...
    public function setUploadDate($v)
    {
        ...
        if ($this->upload_date !== null || $dt !== null) {
            ...
            if ($currentDateAsString !== $newDateAsString) {
                ...
                $this->modifiedColumns[] = CouponImagesPeer::UPLOAD_DATE;
            }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            return $startcol + 6; // 6 = CouponImagesPeer::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException("Error populating CouponImages object", $e);
        }
    }
    ...
    public function reload($deep = false, PropelPDO $con = null)
    {
        ...
        $stmt = CouponImagesPeer::doSelectStmt($this->buildPkeyCriteria(), $con);
    ...
    public function delete(PropelPDO $con = null)
    {
        ...
        try {
            $deleteQuery = CouponImagesQuery::create()
    ...
    public function save(PropelPDO $con = null)
    {
        ...
        try {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                CouponImagesPeer::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
            $con->commit();
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if ($this->isColumnModified(CouponImagesPeer::ID)) {
            $modifiedColumns[':p' . $index++]  = '`id`';
        }
        if ($this->isColumnModified(CouponImagesPeer::COUPON_ID)) {
            $modifiedColumns[':p' . $index++]  = '`coupon_id`';
        }
        if ($this->isColumnModified(CouponImagesPeer::PATH)) {
            $modifiedColumns[':p' . $index++]  = '`path`';
        }
        if ($this->isColumnModified(CouponImagesPeer::THUMB)) {
            $modifiedColumns[':p' . $index++]  = '`thumb`';
        }
        if ($this->isColumnModified(CouponImagesPeer::TEMP_ID)) {
            $modifiedColumns[':p' . $index++]  = '`temp_id`';
        }
        if ($this->isColumnModified(CouponImagesPeer::UPLOAD_DATE)) {
            $modifiedColumns[':p' . $index++]  = '`upload_date`';
        }

        $sql = sprintf(
            'INSERT INTO `coupon_images` (%s) VALUES (%s)',
    ...
    protected function doValidate($columns = null)
    {
        if (!$this->alreadyInValidation) {
            ...
            if (($retval = CouponImagesPeer::doValidate($this, $columns)) !== true) {
    ...
    {
        $pos = CouponImagesPeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
    ...
    {
        if (isset($alreadyDumpedObjects['CouponImages'][$this->getPrimaryKey()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['CouponImages'][$this->getPrimaryKey()] = true;
        $keys = CouponImagesPeer::getFieldNames($keyType);
        $result = array(
            $keys[0] => $this->getId(),
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(CouponImagesPeer::ID)) $criteria->add(CouponImagesPeer::ID, $this->id);
        if ($this->isColumnModified(CouponImagesPeer::COUPON_ID)) $criteria->add(CouponImagesPeer::COUPON_ID, $this->coupon_id);
        if ($this->isColumnModified(CouponImagesPeer::PATH)) $criteria->add(CouponImagesPeer::PATH, $this->path);
        if ($this->isColumnModified(CouponImagesPeer::THUMB)) $criteria->add(CouponImagesPeer::THUMB, $this->thumb);
        if ($this->isColumnModified(CouponImagesPeer::TEMP_ID)) $criteria->add(CouponImagesPeer::TEMP_ID, $this->temp_id);
        if ($this->isColumnModified(CouponImagesPeer::UPLOAD_DATE)) $criteria->add(CouponImagesPeer::UPLOAD_DATE, $this->upload_date);
    ...
    {
        $criteria = new Criteria(CouponImagesPeer::DATABASE_NAME);
        $criteria->add(CouponImagesPeer::ID, $this->id);
     ...
     * objects.
     *
     * @param object $copyObj An object of CouponImages (or compatible) type.
     ...
     *
     * @param boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return CouponImages Clone of current object.
     * @throws PropelException
     */
     ...
     *
     * @return CouponImagesPeer
     */
    public function getPeer()
    {
        if (self::$peer === null) {
            self::$peer = new CouponImagesPeer();
        }
    ...
    public function getCoupons(PropelPDO $con = null, $doQuery = true)
    {
        if ($this->aCoupons === null && ($this->coupon_id !== null) && $doQuery) {
            ...
            /* The following can be used additionally to
                ...
                $this->aCoupons->addCouponImagess($this);
             */
        }
    ...
    {
        return (string) $this->exportTo(CouponImagesPeer::DEFAULT_STRING_FORMAT);
    }
