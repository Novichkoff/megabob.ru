...
abstract class BaseNews extends BaseObject implements Persistent
{
     ...
     * Peer class name
     */
    const PEER = 'Admin\\AdminBundle\\Model\\NewsPeer';
    ...
    public function setAlias($v)
    {
        ...
        if ($this->alias !== $v) {
            $this->alias = $v;
            $this->modifiedColumns[] = NewsPeer::ALIAS;
        }
    ...
    public function setIcon($v)
    {
        ...
        if ($this->icon !== $v) {
            $this->icon = $v;
            $this->modifiedColumns[] = NewsPeer::ICON;
        }
    ...
    public function setViewed($v)
    {
        ...
        if ($this->viewed !== $v) {
            $this->viewed = $v;
            $this->modifiedColumns[] = NewsPeer::VIEWED;
        }
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if ($this->isColumnModified(NewsPeer::ALIAS)) {
            $modifiedColumns[':p' . $index++]  = '`alias`';
        }
        if ($this->isColumnModified(NewsPeer::ICON)) {
            $modifiedColumns[':p' . $index++]  = '`icon`';
        }
        if ($this->isColumnModified(NewsPeer::DESCRIPTION)) {
            $modifiedColumns[':p' . $index++]  = '`description`';
        }
        if ($this->isColumnModified(NewsPeer::VIEWED)) {
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(NewsPeer::ALIAS)) $criteria->add(NewsPeer::ALIAS, $this->alias);
        if ($this->isColumnModified(NewsPeer::ICON)) $criteria->add(NewsPeer::ICON, $this->icon);
        if ($this->isColumnModified(NewsPeer::DESCRIPTION)) $criteria->add(NewsPeer::DESCRIPTION, $this->description);
        if ($this->isColumnModified(NewsPeer::VIEWED)) $criteria->add(NewsPeer::VIEWED, $this->viewed);
