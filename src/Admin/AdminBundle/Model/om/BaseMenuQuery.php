...
use Admin\AdminBundle\Model\MenuPeer;
 ...
 * @method MenuQuery orderByPath($order = Criteria::ASC) Order by the path column
 *
 * @method MenuQuery groupById() Group by the id column
 * @method MenuQuery groupByName() Group by the name column
 * @method MenuQuery groupByPath() Group by the path column
 *
 ...
 * @method Menu findOneByPath(string $path) Return the first Menu filtered by the path column
 *
 ...
 * @method array findByPath(string $path) Return Menu objects filtered by the path column
 */
abstract class BaseMenuQuery extends ModelCriteria
{
    ...
    public function __construct($dbName = null, $modelName = null, $modelAlias = null)
    {
        ...
        if (null === $modelName) {
            $modelName = 'Admin\\AdminBundle\\Model\\Menu';
        }
    ...
    {
        $sql = 'SELECT `id`, `name`, `path` FROM `menu` WHERE `id` = :p0';
        try {
    ...
    public function filterByPath($path = null, $comparison = null)
    {
        ...
        return $this->addUsingAlias(MenuPeer::PATH, $path, $comparison);
    }
