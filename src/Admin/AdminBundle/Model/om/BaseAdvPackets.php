...
abstract class BaseAdvPackets extends BaseObject implements Persistent
{
    /**
     * Peer class name
     */
    const PEER = 'Admin\\AdminBundle\\Model\\AdvPacketsPeer';
    ...
    /**
     * Initializes internal state of BaseAdvPackets object.
     * @see        applyDefaults()
     */
     ...
     * @return AdvPackets The current object (for fluent API support)
     */
    public function setId($v)
    {
        ...
        if ($this->id !== $v) {
            $this->id = $v;
            $this->modifiedColumns[] = AdvPacketsPeer::ID;
        }
    ...
    public function setAdvId($v)
    {
        ...
        if ($this->adv_id !== $v) {
            $this->adv_id = $v;
            $this->modifiedColumns[] = AdvPacketsPeer::ADV_ID;
        }
    ...
    public function setPacketId($v)
    {
        ...
        if ($this->packet_id !== $v) {
            $this->packet_id = $v;
            $this->modifiedColumns[] = AdvPacketsPeer::PACKET_ID;
        }

        if ($this->aPackets !== null && $this->aPackets->getId() !== $v) {
            $this->aPackets = null;
        }
    ...
    public function setEnabled($v)
    {
        ...
        if ($this->enabled !== $v) {
            $this->enabled = $v;
            $this->modifiedColumns[] = AdvPacketsPeer::ENABLED;
        }
    ...
    public function setDeleted($v)
    {
        ...
        if ($this->deleted !== $v) {
            $this->deleted = $v;
            $this->modifiedColumns[] = AdvPacketsPeer::DELETED;
        }
    ...
    public function setPaid($v)
    {
        ...
        if ($this->paid !== $v) {
            $this->paid = $v;
            $this->modifiedColumns[] = AdvPacketsPeer::PAID;
        }
    ...
    public function setDate($v)
    {
        ...
        if ($this->date !== null || $dt !== null) {
            ...
            if ($currentDateAsString !== $newDateAsString) {
                ...
                $this->modifiedColumns[] = AdvPacketsPeer::DATE;
            }
    ...
    public function setUseBefore($v)
    {
        ...
        if ($this->use_before !== null || $dt !== null) {
            ...
            if ($currentDateAsString !== $newDateAsString) {
                ...
                $this->modifiedColumns[] = AdvPacketsPeer::USE_BEFORE;
            }
        } // if either are not null
    ...
    public function setPaidDate($v)
    {
        ...
        if ($this->paid_date !== null || $dt !== null) {
            ...
            if ($currentDateAsString !== $newDateAsString) {
                ...
                $this->modifiedColumns[] = AdvPacketsPeer::PAID_DATE;
            }
        } // if either are not null
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            return $startcol + 9; // 9 = AdvPacketsPeer::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException("Error populating AdvPackets object", $e);
        }
    }
    ...
    public function ensureConsistency()
    {
        ...
        if ($this->aPackets !== null && $this->packet_id !== $this->aPackets->getId()) {
            $this->aPackets = null;
        }
    } // ensureConsistency
    ...
    public function reload($deep = false, PropelPDO $con = null)
    {
        ...
        $stmt = AdvPacketsPeer::doSelectStmt($this->buildPkeyCriteria(), $con);
    ...
    public function delete(PropelPDO $con = null)
    {
        ...
        try {
            $deleteQuery = AdvPacketsQuery::create()
    ...
    public function save(PropelPDO $con = null)
    {
        ...
        try {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                AdvPacketsPeer::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
            $con->commit();
    ...
    protected function doSave(PropelPDO $con)
    {
        ...
        if (!$this->alreadyInSave) {
            ...
            if ($this->aPackets !== null) {
                if ($this->aPackets->isModified() || $this->aPackets->isNew()) {
                    $affectedRows += $this->aPackets->save($con);
                }
                $this->setPackets($this->aPackets);
            }
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if ($this->isColumnModified(AdvPacketsPeer::ID)) {
            $modifiedColumns[':p' . $index++]  = '`id`';
        }
        if ($this->isColumnModified(AdvPacketsPeer::ADV_ID)) {
            $modifiedColumns[':p' . $index++]  = '`adv_id`';
        }
        if ($this->isColumnModified(AdvPacketsPeer::PACKET_ID)) {
            $modifiedColumns[':p' . $index++]  = '`packet_id`';
        }
        if ($this->isColumnModified(AdvPacketsPeer::ENABLED)) {
            $modifiedColumns[':p' . $index++]  = '`enabled`';
        }
        if ($this->isColumnModified(AdvPacketsPeer::DELETED)) {
            $modifiedColumns[':p' . $index++]  = '`deleted`';
        }
        if ($this->isColumnModified(AdvPacketsPeer::PAID)) {
            $modifiedColumns[':p' . $index++]  = '`paid`';
        }
        if ($this->isColumnModified(AdvPacketsPeer::DATE)) {
            $modifiedColumns[':p' . $index++]  = '`date`';
        }
        if ($this->isColumnModified(AdvPacketsPeer::USE_BEFORE)) {
            $modifiedColumns[':p' . $index++]  = '`use_before`';
        }
        if ($this->isColumnModified(AdvPacketsPeer::PAID_DATE)) {
            $modifiedColumns[':p' . $index++]  = '`paid_date`';
        }

        $sql = sprintf(
            'INSERT INTO `adv_packets` (%s) VALUES (%s)',
    ...
    protected function doValidate($columns = null)
    {
        if (!$this->alreadyInValidation) {
            ...
            if ($this->aPackets !== null) {
                if (!$this->aPackets->validate($columns)) {
                    $failureMap = array_merge($failureMap, $this->aPackets->getValidationFailures());
                }
            }


            if (($retval = AdvPacketsPeer::doValidate($this, $columns)) !== true) {
    ...
    {
        $pos = AdvPacketsPeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
    ...
    {
        if (isset($alreadyDumpedObjects['AdvPackets'][$this->getPrimaryKey()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['AdvPackets'][$this->getPrimaryKey()] = true;
        $keys = AdvPacketsPeer::getFieldNames($keyType);
        $result = array(
            $keys[0] => $this->getId(),
        ...
        if ($includeForeignObjects) {
            ...
            if (null !== $this->aPackets) {
                $result['Packets'] = $this->aPackets->toArray($keyType, $includeLazyLoadColumns,  $alreadyDumpedObjects, true);
            }
        }
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(AdvPacketsPeer::ID)) $criteria->add(AdvPacketsPeer::ID, $this->id);
        if ($this->isColumnModified(AdvPacketsPeer::ADV_ID)) $criteria->add(AdvPacketsPeer::ADV_ID, $this->adv_id);
        if ($this->isColumnModified(AdvPacketsPeer::PACKET_ID)) $criteria->add(AdvPacketsPeer::PACKET_ID, $this->packet_id);
        if ($this->isColumnModified(AdvPacketsPeer::ENABLED)) $criteria->add(AdvPacketsPeer::ENABLED, $this->enabled);
        if ($this->isColumnModified(AdvPacketsPeer::DELETED)) $criteria->add(AdvPacketsPeer::DELETED, $this->deleted);
        if ($this->isColumnModified(AdvPacketsPeer::PAID)) $criteria->add(AdvPacketsPeer::PAID, $this->paid);
        if ($this->isColumnModified(AdvPacketsPeer::DATE)) $criteria->add(AdvPacketsPeer::DATE, $this->date);
        if ($this->isColumnModified(AdvPacketsPeer::USE_BEFORE)) $criteria->add(AdvPacketsPeer::USE_BEFORE, $this->use_before);
        if ($this->isColumnModified(AdvPacketsPeer::PAID_DATE)) $criteria->add(AdvPacketsPeer::PAID_DATE, $this->paid_date);
    ...
    {
        $criteria = new Criteria(AdvPacketsPeer::DATABASE_NAME);
        $criteria->add(AdvPacketsPeer::ID, $this->id);
     ...
     * objects.
     *
     * @param object $copyObj An object of AdvPackets (or compatible) type.
     ...
     *
     * @param boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return AdvPackets Clone of current object.
     * @throws PropelException
     */
     ...
     *
     * @return AdvPacketsPeer
     */
    public function getPeer()
    {
        if (self::$peer === null) {
            self::$peer = new AdvPacketsPeer();
        }
    ...
    public function getAdvs(PropelPDO $con = null, $doQuery = true)
    {
        if ($this->aAdvs === null && ($this->adv_id !== null) && $doQuery) {
            ...
            /* The following can be used additionally to
                ...
                $this->aAdvs->addAdvPacketss($this);
             */
        }
    ...
    /**
     * Declares an association between this object and a Packets object.
     *
     * @param                  Packets $v
     * @return AdvPackets The current object (for fluent API support)
     * @throws PropelException
    ...
    {
        if ($v === null) {
            $this->setPacketId(NULL);
        } else {
            $this->setPacketId($v->getId());
        }

        $this->aPackets = $v;

        // Add binding for other direction of this n:n relationship.
        // If this object has already been added to the Packets object, it will not be re-added.
        if ($v !== null) {
            $v->addAdvPackets($this);
        }
    ...
    /**
     * Get the associated Packets object
     *
     * @param PropelPDO $con Optional Connection object.
     * @param $doQuery Executes a query to get the object if required
     * @return Packets The associated Packets object.
     * @throws PropelException
     */
    public function getPackets(PropelPDO $con = null, $doQuery = true)
    {
        if ($this->aPackets === null && ($this->packet_id !== null) && $doQuery) {
            $this->aPackets = PacketsQuery::create()->findPk($this->packet_id, $con);
            /* The following can be used additionally to
                guarantee the related object contains a reference
                to this object.  This level of coupling may, however, be
                undesirable since it could result in an only partially populated collection
                in the referenced object.
                $this->aPackets->addAdvPacketss($this);
             */
        }

        return $this->aPackets;
    }
    ...
    public function clearAllReferences($deep = false)
    {
        if ($deep && !$this->alreadyInClearAllReferencesDeep) {
            ...
            if ($this->aPackets instanceof Persistent) {
              $this->aPackets->clearAllReferences($deep);
            }
    ...
    {
        return (string) $this->exportTo(AdvPacketsPeer::DEFAULT_STRING_FORMAT);
    }
