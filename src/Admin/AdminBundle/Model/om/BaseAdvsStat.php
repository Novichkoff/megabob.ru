...
abstract class BaseAdvsStat extends BaseObject implements Persistent
{
    /**
     * Peer class name
     */
    const PEER = 'Admin\\AdminBundle\\Model\\AdvsStatPeer';
    ...
    /**
     * Initializes internal state of BaseAdvsStat object.
     * @see        applyDefaults()
     */
     ...
     * @return AdvsStat The current object (for fluent API support)
     */
    public function setId($v)
    {
        ...
        if ($this->id !== $v) {
            $this->id = $v;
            $this->modifiedColumns[] = AdvsStatPeer::ID;
        }
    ...
    public function setAdvId($v)
    {
        ...
        if ($this->adv_id !== $v) {
            $this->adv_id = $v;
            $this->modifiedColumns[] = AdvsStatPeer::ADV_ID;
        }
    ...
    public function setShows($v)
    {
        ...
        if ($this->shows !== $v) {
            $this->shows = $v;
            $this->modifiedColumns[] = AdvsStatPeer::SHOWS;
        }
    ...
    public function setClicks($v)
    {
        ...
        if ($this->clicks !== $v) {
            $this->clicks = $v;
            $this->modifiedColumns[] = AdvsStatPeer::CLICKS;
        }
    ...
    public function setStatDate($v)
    {
        ...
        if ($this->stat_date !== null || $dt !== null) {
            ...
            if ($currentDateAsString !== $newDateAsString) {
                ...
                $this->modifiedColumns[] = AdvsStatPeer::STAT_DATE;
            }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            return $startcol + 5; // 5 = AdvsStatPeer::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException("Error populating AdvsStat object", $e);
        }
    }
    ...
    public function reload($deep = false, PropelPDO $con = null)
    {
        ...
        $stmt = AdvsStatPeer::doSelectStmt($this->buildPkeyCriteria(), $con);
    ...
    public function delete(PropelPDO $con = null)
    {
        ...
        try {
            $deleteQuery = AdvsStatQuery::create()
    ...
    public function save(PropelPDO $con = null)
    {
        ...
        try {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                AdvsStatPeer::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
            $con->commit();
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if ($this->isColumnModified(AdvsStatPeer::ID)) {
            $modifiedColumns[':p' . $index++]  = '`id`';
        }
        if ($this->isColumnModified(AdvsStatPeer::ADV_ID)) {
            $modifiedColumns[':p' . $index++]  = '`adv_id`';
        }
        if ($this->isColumnModified(AdvsStatPeer::SHOWS)) {
            $modifiedColumns[':p' . $index++]  = '`shows`';
        }
        if ($this->isColumnModified(AdvsStatPeer::CLICKS)) {
            $modifiedColumns[':p' . $index++]  = '`clicks`';
        }
        if ($this->isColumnModified(AdvsStatPeer::STAT_DATE)) {
            $modifiedColumns[':p' . $index++]  = '`stat_date`';
        }

        $sql = sprintf(
            'INSERT INTO `advs_stat` (%s) VALUES (%s)',
    ...
    protected function doValidate($columns = null)
    {
        if (!$this->alreadyInValidation) {
            ...
            if (($retval = AdvsStatPeer::doValidate($this, $columns)) !== true) {
    ...
    {
        $pos = AdvsStatPeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
    ...
    {
        if (isset($alreadyDumpedObjects['AdvsStat'][$this->getPrimaryKey()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['AdvsStat'][$this->getPrimaryKey()] = true;
        $keys = AdvsStatPeer::getFieldNames($keyType);
        $result = array(
            $keys[0] => $this->getId(),
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(AdvsStatPeer::ID)) $criteria->add(AdvsStatPeer::ID, $this->id);
        if ($this->isColumnModified(AdvsStatPeer::ADV_ID)) $criteria->add(AdvsStatPeer::ADV_ID, $this->adv_id);
        if ($this->isColumnModified(AdvsStatPeer::SHOWS)) $criteria->add(AdvsStatPeer::SHOWS, $this->shows);
        if ($this->isColumnModified(AdvsStatPeer::CLICKS)) $criteria->add(AdvsStatPeer::CLICKS, $this->clicks);
        if ($this->isColumnModified(AdvsStatPeer::STAT_DATE)) $criteria->add(AdvsStatPeer::STAT_DATE, $this->stat_date);
    ...
    {
        $criteria = new Criteria(AdvsStatPeer::DATABASE_NAME);
        $criteria->add(AdvsStatPeer::ID, $this->id);
     ...
     * objects.
     *
     * @param object $copyObj An object of AdvsStat (or compatible) type.
     ...
     *
     * @param boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return AdvsStat Clone of current object.
     * @throws PropelException
     */
    ...
    {
        return (string) $this->exportTo(AdvsStatPeer::DEFAULT_STRING_FORMAT);
    }
