 ...
 * @method PagesQuery orderByIcon($order = Criteria::ASC) Order by the icon column
 * @method PagesQuery orderByDescription($order = Criteria::ASC) Order by the description column
 * @method PagesQuery orderByViewed($order = Criteria::ASC) Order by the viewed column
 * @method PagesQuery orderByContent($order = Criteria::ASC) Order by the content column
 * @method PagesQuery orderByCreatedAt($order = Criteria::ASC) Order by the created_at column
 * @method PagesQuery orderByUpdatedAt($order = Criteria::ASC) Order by the updated_at column
 *
 ...
 * @method PagesQuery groupByIcon() Group by the icon column
 * @method PagesQuery groupByDescription() Group by the description column
 * @method PagesQuery groupByViewed() Group by the viewed column
 * @method PagesQuery groupByContent() Group by the content column
 * @method PagesQuery groupByCreatedAt() Group by the created_at column
 * @method PagesQuery groupByUpdatedAt() Group by the updated_at column
 *
 ...
 * @method Pages findOneByIcon(string $icon) Return the first Pages filtered by the icon column
 * @method Pages findOneByDescription(string $description) Return the first Pages filtered by the description column
 * @method Pages findOneByViewed(int $viewed) Return the first Pages filtered by the viewed column
 * @method Pages findOneByContent(string $content) Return the first Pages filtered by the content column
 * @method Pages findOneByCreatedAt(string $created_at) Return the first Pages filtered by the created_at column
 * @method Pages findOneByUpdatedAt(string $updated_at) Return the first Pages filtered by the updated_at column
 *
 ...
 * @method array findByIcon(string $icon) Return Pages objects filtered by the icon column
 * @method array findByDescription(string $description) Return Pages objects filtered by the description column
 * @method array findByViewed(int $viewed) Return Pages objects filtered by the viewed column
 * @method array findByContent(string $content) Return Pages objects filtered by the content column
 * @method array findByCreatedAt(string $created_at) Return Pages objects filtered by the created_at column
 * @method array findByUpdatedAt(string $updated_at) Return Pages objects filtered by the updated_at column
 */
abstract class BasePagesQuery extends ModelCriteria
{
    ...
    public function __construct($dbName = null, $modelName = null, $modelAlias = null)
    {
        ...
        if (null === $modelName) {
            $modelName = 'Admin\\AdminBundle\\Model\\Pages';
        }
    ...
    {
        $sql = 'SELECT `id`, `title`, `alias`, `icon`, `description`, `viewed`, `content`, `created_at`, `updated_at` FROM `pages` WHERE `id` = :p0';
        try {
    ...
    public function filterByIcon($icon = null, $comparison = null)
    {
        ...
        return $this->addUsingAlias(PagesPeer::ICON, $icon, $comparison);
    }
    ...
    public function filterByDescription($description = null, $comparison = null)
    {
        ...
        return $this->addUsingAlias(PagesPeer::DESCRIPTION, $description, $comparison);
    }
    ...
    public function filterByViewed($viewed = null, $comparison = null)
    {
        if (is_array($viewed)) {
            $useMinMax = false;
            if (isset($viewed['min'])) {
                $this->addUsingAlias(PagesPeer::VIEWED, $viewed['min'], Criteria::GREATER_EQUAL);
                $useMinMax = true;
            }
            if (isset($viewed['max'])) {
                $this->addUsingAlias(PagesPeer::VIEWED, $viewed['max'], Criteria::LESS_EQUAL);
                $useMinMax = true;
            }
            if ($useMinMax) {
                return $this;
        ...
        return $this->addUsingAlias(PagesPeer::VIEWED, $viewed, $comparison);
    }
    ...
    public function filterByCreatedAt($createdAt = null, $comparison = null)
    {
        if (is_array($createdAt)) {
            ...
            if (isset($createdAt['min'])) {
                $this->addUsingAlias(PagesPeer::CREATED_AT, $createdAt['min'], Criteria::GREATER_EQUAL);
                $useMinMax = true;
            }
            if (isset($createdAt['max'])) {
                $this->addUsingAlias(PagesPeer::CREATED_AT, $createdAt['max'], Criteria::LESS_EQUAL);
                $useMinMax = true;
            }
            if ($useMinMax) {
                return $this;
        ...
        return $this->addUsingAlias(PagesPeer::CREATED_AT, $createdAt, $comparison);
    }
    ...
    public function filterByUpdatedAt($updatedAt = null, $comparison = null)
    {
        if (is_array($updatedAt)) {
            ...
            if (isset($updatedAt['min'])) {
                $this->addUsingAlias(PagesPeer::UPDATED_AT, $updatedAt['min'], Criteria::GREATER_EQUAL);
                $useMinMax = true;
            }
            if (isset($updatedAt['max'])) {
                $this->addUsingAlias(PagesPeer::UPDATED_AT, $updatedAt['max'], Criteria::LESS_EQUAL);
                $useMinMax = true;
            }
            if ($useMinMax) {
                return $this;
        ...
        return $this->addUsingAlias(PagesPeer::UPDATED_AT, $updatedAt, $comparison);
    }
    ...
    {
        return $this->addUsingAlias(PagesPeer::UPDATED_AT, time() - $nbDays * 24 * 60 * 60, Criteria::GREATER_EQUAL);
    }
    ...
    {
        return $this->addDescendingOrderByColumn(PagesPeer::UPDATED_AT);
    }
    ...
    {
        return $this->addAscendingOrderByColumn(PagesPeer::UPDATED_AT);
    }
    ...
    {
        return $this->addUsingAlias(PagesPeer::CREATED_AT, time() - $nbDays * 24 * 60 * 60, Criteria::GREATER_EQUAL);
    }
    ...
    {
        return $this->addDescendingOrderByColumn(PagesPeer::CREATED_AT);
    }
    ...
    {
        return $this->addAscendingOrderByColumn(PagesPeer::CREATED_AT);
    }
}
