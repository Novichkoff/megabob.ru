...
use Admin\AdminBundle\Model\map\NewsTableMap;
...
abstract class BaseNewsPeer
{
    ...
    const OM_CLASS = 'Admin\\AdminBundle\\Model\\News';

    /** the related TableMap class for this table */
    const TM_CLASS = 'Admin\\AdminBundle\\Model\\map\\NewsTableMap';
    ...
    protected static $fieldNames = array (
        ...
        BasePeer::TYPE_COLNAME => array (NewsPeer::ID, NewsPeer::TITLE, NewsPeer::ALIAS, NewsPeer::ICON, NewsPeer::DESCRIPTION, NewsPeer::VIEWED, NewsPeer::CONTENT, NewsPeer::CREATED_AT, NewsPeer::UPDATED_AT, ),
    ...
    protected static $fieldKeys = array (
        ...
        BasePeer::TYPE_COLNAME => array (NewsPeer::ID => 0, NewsPeer::TITLE => 1, NewsPeer::ALIAS => 2, NewsPeer::ICON => 3, NewsPeer::DESCRIPTION => 4, NewsPeer::VIEWED => 5, NewsPeer::CONTENT => 6, NewsPeer::CREATED_AT => 7, NewsPeer::UPDATED_AT => 8, ),
    ...
    public static function addSelectColumns(Criteria $criteria, $alias = null)
    {
        if (null === $alias) {
            ...
            $criteria->addSelectColumn(NewsPeer::ALIAS);
            $criteria->addSelectColumn(NewsPeer::ICON);
            $criteria->addSelectColumn(NewsPeer::DESCRIPTION);
            $criteria->addSelectColumn(NewsPeer::VIEWED);
    ...
    public static function buildTableMap()
    {
      ...
      if (!$dbMap->hasTable(BaseNewsPeer::TABLE_NAME)) {
        $dbMap->addTableObject(new \Admin\AdminBundle\Model\map\NewsTableMap());
      }
    }
