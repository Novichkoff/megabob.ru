...
abstract class BaseJobParams extends BaseObject implements Persistent
{
    /**
     * Peer class name
     */
    const PEER = 'Admin\\AdminBundle\\Model\\JobParamsPeer';
    ...
    /**
     * @var        JobCategoriesFieldsValues
     */
    protected $aJobCategoriesFieldsValues;
     ...
     * @return JobParams The current object (for fluent API support)
     */
    public function setId($v)
    {
        ...
        if ($this->id !== $v) {
            $this->id = $v;
            $this->modifiedColumns[] = JobParamsPeer::ID;
        }
    ...
    public function setJobId($v)
    {
        ...
        if ($this->job_id !== $v) {
            $this->job_id = $v;
            $this->modifiedColumns[] = JobParamsPeer::JOB_ID;
        }
    ...
    public function setFieldId($v)
    {
        ...
        if ($this->field_id !== $v) {
            $this->field_id = $v;
            $this->modifiedColumns[] = JobParamsPeer::FIELD_ID;
        }
    ...
    public function setValueId($v)
    {
        ...
        if ($this->value_id !== $v) {
            $this->value_id = $v;
            $this->modifiedColumns[] = JobParamsPeer::VALUE_ID;
        }

        if ($this->aJobCategoriesFieldsValues !== null && $this->aJobCategoriesFieldsValues->getId() !== $v) {
            $this->aJobCategoriesFieldsValues = null;
        }
    ...
    public function setTextValue($v)
    {
        ...
        if ($this->text_value !== $v) {
            $this->text_value = $v;
            $this->modifiedColumns[] = JobParamsPeer::TEXT_VALUE;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            return $startcol + 5; // 5 = JobParamsPeer::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException("Error populating JobParams object", $e);
        }
    }
    ...
    public function ensureConsistency()
    {
        ...
        if ($this->aJobCategoriesFieldsValues !== null && $this->value_id !== $this->aJobCategoriesFieldsValues->getId()) {
            $this->aJobCategoriesFieldsValues = null;
        }
    } // ensureConsistency
    ...
    public function reload($deep = false, PropelPDO $con = null)
    {
        ...
        $stmt = JobParamsPeer::doSelectStmt($this->buildPkeyCriteria(), $con);
    ...
    public function delete(PropelPDO $con = null)
    {
        ...
        try {
            $deleteQuery = JobParamsQuery::create()
    ...
    public function save(PropelPDO $con = null)
    {
        ...
        try {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                JobParamsPeer::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
            $con->commit();
    ...
    protected function doSave(PropelPDO $con)
    {
        ...
        if (!$this->alreadyInSave) {
            ...
            if ($this->aJobCategoriesFieldsValues !== null) {
                if ($this->aJobCategoriesFieldsValues->isModified() || $this->aJobCategoriesFieldsValues->isNew()) {
                    $affectedRows += $this->aJobCategoriesFieldsValues->save($con);
                }
                $this->setJobCategoriesFieldsValues($this->aJobCategoriesFieldsValues);
            }
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if ($this->isColumnModified(JobParamsPeer::ID)) {
            $modifiedColumns[':p' . $index++]  = '`id`';
        }
        if ($this->isColumnModified(JobParamsPeer::JOB_ID)) {
            $modifiedColumns[':p' . $index++]  = '`job_id`';
        }
        if ($this->isColumnModified(JobParamsPeer::FIELD_ID)) {
            $modifiedColumns[':p' . $index++]  = '`field_id`';
        }
        if ($this->isColumnModified(JobParamsPeer::VALUE_ID)) {
            $modifiedColumns[':p' . $index++]  = '`value_id`';
        }
        if ($this->isColumnModified(JobParamsPeer::TEXT_VALUE)) {
            $modifiedColumns[':p' . $index++]  = '`text_value`';
        }

        $sql = sprintf(
            'INSERT INTO `job_params` (%s) VALUES (%s)',
    ...
    protected function doValidate($columns = null)
    {
        if (!$this->alreadyInValidation) {
            ...
            if ($this->aJobCategoriesFieldsValues !== null) {
                if (!$this->aJobCategoriesFieldsValues->validate($columns)) {
                    $failureMap = array_merge($failureMap, $this->aJobCategoriesFieldsValues->getValidationFailures());
                }
            }


            if (($retval = JobParamsPeer::doValidate($this, $columns)) !== true) {
    ...
    {
        $pos = JobParamsPeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
    ...
    {
        if (isset($alreadyDumpedObjects['JobParams'][$this->getPrimaryKey()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['JobParams'][$this->getPrimaryKey()] = true;
        $keys = JobParamsPeer::getFieldNames($keyType);
        $result = array(
            $keys[0] => $this->getId(),
        ...
        if ($includeForeignObjects) {
            ...
            if (null !== $this->aJobCategoriesFieldsValues) {
                $result['JobCategoriesFieldsValues'] = $this->aJobCategoriesFieldsValues->toArray($keyType, $includeLazyLoadColumns,  $alreadyDumpedObjects, true);
            }
        }
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(JobParamsPeer::ID)) $criteria->add(JobParamsPeer::ID, $this->id);
        if ($this->isColumnModified(JobParamsPeer::JOB_ID)) $criteria->add(JobParamsPeer::JOB_ID, $this->job_id);
        if ($this->isColumnModified(JobParamsPeer::FIELD_ID)) $criteria->add(JobParamsPeer::FIELD_ID, $this->field_id);
        if ($this->isColumnModified(JobParamsPeer::VALUE_ID)) $criteria->add(JobParamsPeer::VALUE_ID, $this->value_id);
        if ($this->isColumnModified(JobParamsPeer::TEXT_VALUE)) $criteria->add(JobParamsPeer::TEXT_VALUE, $this->text_value);
    ...
    {
        $criteria = new Criteria(JobParamsPeer::DATABASE_NAME);
        $criteria->add(JobParamsPeer::ID, $this->id);
     ...
     * objects.
     *
     * @param object $copyObj An object of JobParams (or compatible) type.
     ...
     *
     * @param boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return JobParams Clone of current object.
     * @throws PropelException
     */
     ...
     *
     * @return JobParamsPeer
     */
    public function getPeer()
    {
        if (self::$peer === null) {
            self::$peer = new JobParamsPeer();
        }
    ...
    public function getJobCategoriesFields(PropelPDO $con = null, $doQuery = true)
    {
        if ($this->aJobCategoriesFields === null && ($this->field_id !== null) && $doQuery) {
            ...
            /* The following can be used additionally to
                ...
                $this->aJobCategoriesFields->addJobParamss($this);
             */
        }
    ...
    /**
     * Declares an association between this object and a JobCategoriesFieldsValues object.
     *
     * @param                  JobCategoriesFieldsValues $v
     * @return JobParams The current object (for fluent API support)
     * @throws PropelException
     */
    public function setJobCategoriesFieldsValues(JobCategoriesFieldsValues $v = null)
    {
        if ($v === null) {
        ...
        $this->aJobCategoriesFieldsValues = $v;

        // Add binding for other direction of this n:n relationship.
        // If this object has already been added to the JobCategoriesFieldsValues object, it will not be re-added.
        if ($v !== null) {
            $v->addJobParams($this);
        }
    ...
    /**
     * Get the associated JobCategoriesFieldsValues object
     *
     * @param PropelPDO $con Optional Connection object.
     * @param $doQuery Executes a query to get the object if required
     * @return JobCategoriesFieldsValues The associated JobCategoriesFieldsValues object.
     * @throws PropelException
     */
    public function getJobCategoriesFieldsValues(PropelPDO $con = null, $doQuery = true)
    {
        if ($this->aJobCategoriesFieldsValues === null && ($this->value_id !== null) && $doQuery) {
            $this->aJobCategoriesFieldsValues = JobCategoriesFieldsValuesQuery::create()->findPk($this->value_id, $con);
            /* The following can be used additionally to
                guarantee the related object contains a reference
                to this object.  This level of coupling may, however, be
                undesirable since it could result in an only partially populated collection
                in the referenced object.
                $this->aJobCategoriesFieldsValues->addJobParamss($this);
             */
        }

        return $this->aJobCategoriesFieldsValues;
    }
    ...
    public function clearAllReferences($deep = false)
    {
        if ($deep && !$this->alreadyInClearAllReferencesDeep) {
            ...
            if ($this->aJobCategoriesFieldsValues instanceof Persistent) {
              $this->aJobCategoriesFieldsValues->clearAllReferences($deep);
            }
    ...
    {
        return (string) $this->exportTo(JobParamsPeer::DEFAULT_STRING_FORMAT);
    }
