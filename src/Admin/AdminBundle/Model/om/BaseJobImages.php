...
abstract class BaseJobImages extends BaseObject implements Persistent
{
    /**
     * Peer class name
     */
    const PEER = 'Admin\\AdminBundle\\Model\\JobImagesPeer';
    ...
    /**
     * Initializes internal state of BaseJobImages object.
     * @see        applyDefaults()
     */
     ...
     * @return JobImages The current object (for fluent API support)
     */
    public function setId($v)
    {
        ...
        if ($this->id !== $v) {
            $this->id = $v;
            $this->modifiedColumns[] = JobImagesPeer::ID;
        }
    ...
    public function setJobId($v)
    {
        ...
        if ($this->job_id !== $v) {
            $this->job_id = $v;
            $this->modifiedColumns[] = JobImagesPeer::JOB_ID;
        }
    ...
    public function setPath($v)
    {
        ...
        if ($this->path !== $v) {
            $this->path = $v;
            $this->modifiedColumns[] = JobImagesPeer::PATH;
        }
    ...
    public function setThumb($v)
    {
        ...
        if ($this->thumb !== $v) {
            $this->thumb = $v;
            $this->modifiedColumns[] = JobImagesPeer::THUMB;
        }
    ...
    public function setTempId($v)
    {
        ...
        if ($this->temp_id !== $v) {
            $this->temp_id = $v;
            $this->modifiedColumns[] = JobImagesPeer::TEMP_ID;
        }
    ...
    public function setUploadDate($v)
    {
        ...
        if ($this->upload_date !== null || $dt !== null) {
            ...
            if ($currentDateAsString !== $newDateAsString) {
                ...
                $this->modifiedColumns[] = JobImagesPeer::UPLOAD_DATE;
            }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            return $startcol + 6; // 6 = JobImagesPeer::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException("Error populating JobImages object", $e);
        }
    }
    ...
    public function reload($deep = false, PropelPDO $con = null)
    {
        ...
        $stmt = JobImagesPeer::doSelectStmt($this->buildPkeyCriteria(), $con);
    ...
    public function delete(PropelPDO $con = null)
    {
        ...
        try {
            $deleteQuery = JobImagesQuery::create()
    ...
    public function save(PropelPDO $con = null)
    {
        ...
        try {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                JobImagesPeer::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
            $con->commit();
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if ($this->isColumnModified(JobImagesPeer::ID)) {
            $modifiedColumns[':p' . $index++]  = '`id`';
        }
        if ($this->isColumnModified(JobImagesPeer::JOB_ID)) {
            $modifiedColumns[':p' . $index++]  = '`job_id`';
        }
        if ($this->isColumnModified(JobImagesPeer::PATH)) {
            $modifiedColumns[':p' . $index++]  = '`path`';
        }
        if ($this->isColumnModified(JobImagesPeer::THUMB)) {
            $modifiedColumns[':p' . $index++]  = '`thumb`';
        }
        if ($this->isColumnModified(JobImagesPeer::TEMP_ID)) {
            $modifiedColumns[':p' . $index++]  = '`temp_id`';
        }
        if ($this->isColumnModified(JobImagesPeer::UPLOAD_DATE)) {
            $modifiedColumns[':p' . $index++]  = '`upload_date`';
        }

        $sql = sprintf(
            'INSERT INTO `job_images` (%s) VALUES (%s)',
    ...
    protected function doValidate($columns = null)
    {
        if (!$this->alreadyInValidation) {
            ...
            if (($retval = JobImagesPeer::doValidate($this, $columns)) !== true) {
    ...
    {
        $pos = JobImagesPeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
    ...
    {
        if (isset($alreadyDumpedObjects['JobImages'][$this->getPrimaryKey()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['JobImages'][$this->getPrimaryKey()] = true;
        $keys = JobImagesPeer::getFieldNames($keyType);
        $result = array(
            $keys[0] => $this->getId(),
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(JobImagesPeer::ID)) $criteria->add(JobImagesPeer::ID, $this->id);
        if ($this->isColumnModified(JobImagesPeer::JOB_ID)) $criteria->add(JobImagesPeer::JOB_ID, $this->job_id);
        if ($this->isColumnModified(JobImagesPeer::PATH)) $criteria->add(JobImagesPeer::PATH, $this->path);
        if ($this->isColumnModified(JobImagesPeer::THUMB)) $criteria->add(JobImagesPeer::THUMB, $this->thumb);
        if ($this->isColumnModified(JobImagesPeer::TEMP_ID)) $criteria->add(JobImagesPeer::TEMP_ID, $this->temp_id);
        if ($this->isColumnModified(JobImagesPeer::UPLOAD_DATE)) $criteria->add(JobImagesPeer::UPLOAD_DATE, $this->upload_date);
    ...
    {
        $criteria = new Criteria(JobImagesPeer::DATABASE_NAME);
        $criteria->add(JobImagesPeer::ID, $this->id);
     ...
     * objects.
     *
     * @param object $copyObj An object of JobImages (or compatible) type.
     ...
     *
     * @param boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return JobImages Clone of current object.
     * @throws PropelException
     */
     ...
     *
     * @return JobImagesPeer
     */
    public function getPeer()
    {
        if (self::$peer === null) {
            self::$peer = new JobImagesPeer();
        }
    ...
    {
        return (string) $this->exportTo(JobImagesPeer::DEFAULT_STRING_FORMAT);
    }
