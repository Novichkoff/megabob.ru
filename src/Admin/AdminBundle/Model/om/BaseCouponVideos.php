...
abstract class BaseCouponVideos extends BaseObject implements Persistent
{
    /**
     * Peer class name
     */
    const PEER = 'Admin\\AdminBundle\\Model\\CouponVideosPeer';

    /**
     * The Peer class.
     * Instance provides a convenient way of calling static methods on a class
     * that calling code may not be able to identify.
     * @var        CouponVideosPeer
     */
    ...
    /**
     * Initializes internal state of BaseCouponVideos object.
     * @see        applyDefaults()
     */
     ...
     * @return CouponVideos The current object (for fluent API support)
     */
    public function setId($v)
    {
        ...
        if ($this->id !== $v) {
            $this->id = $v;
            $this->modifiedColumns[] = CouponVideosPeer::ID;
        }
    ...
    public function setCouponId($v)
    {
        ...
        if ($this->coupon_id !== $v) {
            $this->coupon_id = $v;
            $this->modifiedColumns[] = CouponVideosPeer::COUPON_ID;
        }
    ...
    public function setPath($v)
    {
        ...
        if ($this->path !== $v) {
            $this->path = $v;
            $this->modifiedColumns[] = CouponVideosPeer::PATH;
        }
    ...
    public function setThumb($v)
    {
        ...
        if ($this->thumb !== $v) {
            $this->thumb = $v;
            $this->modifiedColumns[] = CouponVideosPeer::THUMB;
        }
    ...
    public function setTempId($v)
    {
        ...
        if ($this->temp_id !== $v) {
            $this->temp_id = $v;
            $this->modifiedColumns[] = CouponVideosPeer::TEMP_ID;
        }
    ...
    public function setUploadDate($v)
    {
        ...
        if ($this->upload_date !== null || $dt !== null) {
            ...
            if ($currentDateAsString !== $newDateAsString) {
                ...
                $this->modifiedColumns[] = CouponVideosPeer::UPLOAD_DATE;
            }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            return $startcol + 6; // 6 = CouponVideosPeer::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException("Error populating CouponVideos object", $e);
        }
    }
    ...
    public function reload($deep = false, PropelPDO $con = null)
    {
        ...
        $stmt = CouponVideosPeer::doSelectStmt($this->buildPkeyCriteria(), $con);
    ...
    public function delete(PropelPDO $con = null)
    {
        ...
        try {
            $deleteQuery = CouponVideosQuery::create()
    ...
    public function save(PropelPDO $con = null)
    {
        ...
        try {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                CouponVideosPeer::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
            $con->commit();
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if ($this->isColumnModified(CouponVideosPeer::ID)) {
            $modifiedColumns[':p' . $index++]  = '`id`';
        }
        if ($this->isColumnModified(CouponVideosPeer::COUPON_ID)) {
            $modifiedColumns[':p' . $index++]  = '`coupon_id`';
        }
        if ($this->isColumnModified(CouponVideosPeer::PATH)) {
            $modifiedColumns[':p' . $index++]  = '`path`';
        }
        if ($this->isColumnModified(CouponVideosPeer::THUMB)) {
            $modifiedColumns[':p' . $index++]  = '`thumb`';
        }
        if ($this->isColumnModified(CouponVideosPeer::TEMP_ID)) {
            $modifiedColumns[':p' . $index++]  = '`temp_id`';
        }
        if ($this->isColumnModified(CouponVideosPeer::UPLOAD_DATE)) {
            $modifiedColumns[':p' . $index++]  = '`upload_date`';
        }

        $sql = sprintf(
            'INSERT INTO `coupon_videos` (%s) VALUES (%s)',
    ...
    protected function doValidate($columns = null)
    {
        if (!$this->alreadyInValidation) {
            ...
            if (($retval = CouponVideosPeer::doValidate($this, $columns)) !== true) {
    ...
    {
        $pos = CouponVideosPeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
    ...
    {
        if (isset($alreadyDumpedObjects['CouponVideos'][$this->getPrimaryKey()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['CouponVideos'][$this->getPrimaryKey()] = true;
        $keys = CouponVideosPeer::getFieldNames($keyType);
        $result = array(
            $keys[0] => $this->getId(),
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(CouponVideosPeer::ID)) $criteria->add(CouponVideosPeer::ID, $this->id);
        if ($this->isColumnModified(CouponVideosPeer::COUPON_ID)) $criteria->add(CouponVideosPeer::COUPON_ID, $this->coupon_id);
        if ($this->isColumnModified(CouponVideosPeer::PATH)) $criteria->add(CouponVideosPeer::PATH, $this->path);
        if ($this->isColumnModified(CouponVideosPeer::THUMB)) $criteria->add(CouponVideosPeer::THUMB, $this->thumb);
        if ($this->isColumnModified(CouponVideosPeer::TEMP_ID)) $criteria->add(CouponVideosPeer::TEMP_ID, $this->temp_id);
        if ($this->isColumnModified(CouponVideosPeer::UPLOAD_DATE)) $criteria->add(CouponVideosPeer::UPLOAD_DATE, $this->upload_date);
    ...
    {
        $criteria = new Criteria(CouponVideosPeer::DATABASE_NAME);
        $criteria->add(CouponVideosPeer::ID, $this->id);
     ...
     * objects.
     *
     * @param object $copyObj An object of CouponVideos (or compatible) type.
     ...
     *
     * @param boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return CouponVideos Clone of current object.
     * @throws PropelException
     */
     ...
     *
     * @return CouponVideosPeer
     */
    public function getPeer()
    {
        if (self::$peer === null) {
            self::$peer = new CouponVideosPeer();
        }
    ...
    public function getCoupons(PropelPDO $con = null, $doQuery = true)
    {
        if ($this->aCoupons === null && ($this->coupon_id !== null) && $doQuery) {
            ...
            /* The following can be used additionally to
                ...
                $this->aCoupons->addCouponVideoss($this);
             */
        }
    ...
    {
        return (string) $this->exportTo(CouponVideosPeer::DEFAULT_STRING_FORMAT);
    }
