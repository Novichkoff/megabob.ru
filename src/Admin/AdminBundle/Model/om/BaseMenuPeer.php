...
use Admin\AdminBundle\Model\map\MenuTableMap;
...
abstract class BaseMenuPeer
{
    ...
    const OM_CLASS = 'Admin\\AdminBundle\\Model\\Menu';

    /** the related TableMap class for this table */
    const TM_CLASS = 'Admin\\AdminBundle\\Model\\map\\MenuTableMap';
    ...
    protected static $fieldNames = array (
        ...
        BasePeer::TYPE_COLNAME => array (MenuPeer::ID, MenuPeer::NAME, MenuPeer::PATH, ),
    ...
    protected static $fieldKeys = array (
        ...
        BasePeer::TYPE_COLNAME => array (MenuPeer::ID => 0, MenuPeer::NAME => 1, MenuPeer::PATH => 2, ),
    ...
    public static function addSelectColumns(Criteria $criteria, $alias = null)
    {
        if (null === $alias) {
            ...
            $criteria->addSelectColumn(MenuPeer::PATH);
        } else {
    ...
    public static function buildTableMap()
    {
      ...
      if (!$dbMap->hasTable(BaseMenuPeer::TABLE_NAME)) {
        $dbMap->addTableObject(new \Admin\AdminBundle\Model\map\MenuTableMap());
      }
    }
