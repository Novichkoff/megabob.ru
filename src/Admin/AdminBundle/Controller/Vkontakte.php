...
class Vkontakte
{
     ...
     * @var string
     */
    private $redirect_uri = "https://api.vk.com/blank.html" ;
     ...
     */
    public function postToPublic($publicID, $text, $fullServerPathToImage, $tags = array(), $link = null)
    {
 ...
 */
        ...
        $response = $this->api('wall.post',
            [
                ...
                'from_group' => 1,
                'message' => "$text",
                'attachments' => "{$response[0]->id}".($link?",".$link:""), // uploaded image is passed as attachment
                'version' => '3.0'
