...
class Qiwi{
    ...
    * @var string
    */
    public $rest_pass = '0XuZyeA1uhVIYNM1T5zj';
	...
	*/
    ...
    function redir_link($bill_id, $success_url = '', $fail_url = ''){
        return "https://api.qiwi.com/order/external/main.action?shop=" . $this->shop_id . "&transaction=" . $bill_id .
